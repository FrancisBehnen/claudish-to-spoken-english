...
**Fifteen consecutive rounds of review have each found a real defect in the previous round's
...
### So the counter-argument is now refuted in every round in that table — fifteen of them
