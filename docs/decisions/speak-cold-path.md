...
Then ask it something that produces more than ~200 characters of prose. The answer appears, and
a few seconds later — after the rewrite's own LLM call — it is spoken. `touch
